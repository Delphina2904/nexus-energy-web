...
const Interactive3DBackground = () => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            const targetZ = 15;
            if (!animate.zoomStarted) {
                camera.position.z = 30;
                animate.zoomStarted = true;
            }
...
const ThreeDDevelopmentService = () => {
    ...
    return (
        <div className="min-h-screen bg-background relative">
            {/* Navbar */}
            <Navbar 
                title="3D Development Services - Nexus Energy Solutions"
                description="Professional 3D modeling, visualization, and interactive 3D development services for energy solutions."
            />
            
            {/* Hero Banner with 3D Model Section */}
